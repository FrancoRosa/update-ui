...
Then zip the folder, it must be password protected to avoid someone else creating their fake updates, the password can be customized and saved in `password.txt` on this repo.
